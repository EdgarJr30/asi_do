/**
 * Render del correo: tema por tipo de notificación, HTML y texto plano.
 *
 * Vive separado del procesador porque es puro —entra un objeto, sale una
 * cadena— y porque son 400 líneas de plantilla que, mezcladas con el bucle de
 * entrega, hacían ilegible la parte que sí toca la base de datos y el
 * proveedor.
 */
