...
12. Workspace reports must stay lightweight and scan-first: use a compact period selector, small KPI tiles, unframed funnel/conversion sections, animated horizontal bars, and clear empty/loading/error states. Do not turn report summaries into a card-heavy dashboard or rebuild shared workspace shell chrome inside feature pages.
