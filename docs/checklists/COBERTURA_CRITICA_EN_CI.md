...
| 2026-08-09 | **R7 cerrado**: e2e de recuperación en CI (enlace acuñado con `generateLink`, aterrizaje por fragmento, la contraseña vieja deja de abrir) + 16 tests de unidad de no-divulgación y estados del enlace; guardia de coherencia sobre `additional_redirect_urls` | _(pendiente)_ |
