...
Todas con expiración **12/28** (`202812`). El número va completo (sin espacios) en el campo de tarjeta.

| # | Marca | Número | Exp. | CVV | Uso sugerido |
|---|---|---|---|---|---|
| 1 | Mastercard | `5413 3300 8960 0119` | 12/28 | 979 | **Aprobada** |
| 2 | Visa | `4012 0000 3333 0026` | 12/28 | 123 | **Aprobada** |
| 3 | Discover | `6011 0009 9009 9818` | 12/28 | 818 | **Aprobada** |
| 4 | Mastercard | `5424 1802 7979 1732` | 12/28 | 732 | **Aprobada** |
| 5 | Visa | `4260 5500 6184 5872` | 12/28 | 872 | **Aprobada** |
| 6 | Visa | `4005 5200 0000 0129` | 12/28 | 977 | **Declinada por límite** (tope RD$ 75) |
...
4. El navegador navega a `https://pruebas.azul.com.do/PaymentPage/`. Ingresa una **tarjeta de prueba
   aprobada** y confirma.
5. AZUL te devuelve a `http://localhost:8080/payments/azul/callback...`; el microservicio:
...
|---|---|---|---|
| 1 | **Aprobado** | Tarjeta 1–5 (p. ej. `5413 3300 8960 0119`, CVV 979) | `?payment=approved`, pago `verified`, toast verde, admin puede activar |
| 2 | **Declinado** | Tarjeta 6 `4005 5200 0000 0129` (CVV 977, tope RD$ 75) con cuota ≥ RD$ 1,500 | `?payment=declined`, pago `failed`, toast rojo, botón para reintentar |
