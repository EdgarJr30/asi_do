...
- `architecture/DESPLIEGUE_HOSTINGER.md` (publicación segura del frontend en Hostinger con DNS en Cloudflare)
...
- `storefront` for the product landing, hidden pricing module, and member-gated job entry under `/platform`
