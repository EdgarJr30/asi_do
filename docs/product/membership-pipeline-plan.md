...
5. **Notificaciones + pulido** — eventos por transición; recordatorios de renovación (después). **✅ COMPLETA (envío automático)**
   ...
   - ✅ **Resend**: cuenta y dominio propio `asidominicana.do`, con remitente `ASI Dominicana <notificaciones@asidominicana.do>`, key específica en secretos de Supabase y webhook firmado para conservar los eventos reales de entrega.
