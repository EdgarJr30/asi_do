...
export function ErrorFallback({
  ...
  return (
    ...
    >
      <div className="w-full max-w-md rounded-card-lg border border-(--app-border) bg-(--app-surface-elevated) px-6 py-8 text-center shadow-[0_1px_2px_rgba(20,40,90,0.04),0_4px_16px_rgba(20,40,90,0.05)]">
