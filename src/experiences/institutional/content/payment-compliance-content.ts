...
export const merchantCompliance = {
  ...
  legalName: 'UNION ASOCIACION DOMINICANA DE LOS ADVENTISTAS DEL SEPTIMO DIA',
  email: 'hola@asidominicana.do',
  phone: '+1 829 910 0333',
  address: 'Prolongación Fantino Falco 1A, Piantini, Santo Domingo, R.D.',
  ...
  supportHours: 'lunes a jueves, 9:00 a. m. a 5:00 p. m.',
  // NOTA: reemplazar con los datos registrales reales antes de producción.
  taxId: 'RNC 401-50367-2',
  jurisdiction:
    'Tribunales competentes de Santo Domingo, Distrito Nacional, República Dominicana',
...
export const paymentPolicyLinks = [
  ...
  { label: 'Privacidad', to: surfacePaths.institutional.privacy },
  {
    ...
    to: surfacePaths.institutional.refunds,
  },
  { label: 'Entrega del servicio', to: surfacePaths.institutional.delivery },
  {
    label: 'Seguridad de pagos',
    to: surfacePaths.institutional.paymentSecurity,
  },
] as const;

export type PaymentPolicyKind =
  | 'terms'
  | 'privacy'
  | 'refunds'
  | 'delivery'
